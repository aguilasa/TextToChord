...
public class Consts {
	...
	public static final List<String> CHORDS = Arrays
			.asList(new String[] { "C", "C#", "D", "Eb", "E", "F", "F#", "G", "G#", "A", "Bb", "B" });
	public static final String PATH_FILES = "C:\\Users\\ingmar\\Documents\\GitHub\\congresso-2020\\res\\cifras\\texto";
	public static final String[] MARKERS = new String[] { "Solo", "Solo:", "1x", "2x", "3x", "4x", "5x", "6x", "7x",
			"8x", "9x", "10x", "Passagem:", "|:", ":|", "Final|:", "Interlúdio:", "Final:" };
